...
import SubjectFilter from '../homePage/SubjectFilter';
import SubjectsGrid from '../homePage/SubjectsGrid';
    ...
    <div className="flex flex-col min-h-screen bg-background text-foreground">
      ...
      <main className="flex-1">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-24">
          <h1 className="text-3xl font-bold mb-8 text-center">All Exams</h1>
          <SubjectFilter 
